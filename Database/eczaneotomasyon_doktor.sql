...
CREATE TABLE `doktor` (
  ...
  `HastaneID` varchar(45) DEFAULT NULL,
  `UzmanlıkAlani` varchar(45) DEFAULT NULL,
  `Tecrube` varchar(45) DEFAULT NULL,
...
INSERT INTO `doktor` VALUES (1,'Figen','Gülsoy',NULL,'KBB','20','1234','1234');
